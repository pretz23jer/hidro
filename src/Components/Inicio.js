        ...
        return(
            <div>
                ...
                <div className="container text-center pt-2 pb-5">
                    ...
                    <a href="#" className="btn btn-sm colorBoton animarBotonDescargar" rel="noreferrer">&nbsp;&nbsp;&nbsp;&nbsp;Descarga Hidrocompras&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </div>
                <div  className="container centarContenido mt-4" data-aos="flip-up">
                ...
                <div className="container pt-5" data-aos="flip-down">
                    <div className="row">
                        <div className="col-12 col-md-4 p-5 text-center" data-aos="fade-down">
                            ...
                            <p className="fw-bold text-black h5">Descarga la Appen tu celular</p>
                    ...
                    <div className="text-center pb-5">
                        <div className="d-flex text-center justify-content-center">
                            <div className="justify-content-center p-1">
                                <a href="#" className="btn btn-md btn-dark fw-bold animarBotonDescargar" rel="noreferrer" >&nbsp;&nbsp;Descargar HidroCliente&nbsp;&nbsp;</a>
                            </div>
                            <div className="p-1 justify-content-center">
                                <a href="#" className="btn btn-md btn-dark fw-bold animarBotonDescargar" rel="noreferrer" >&nbsp;&nbsp;Descargar HidroTécnico&nbsp;&nbsp;</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row pt-5 mt-4">
                        <div className="col-12 col-lg-3">
                            <div className="izquiTar tarjetaProducto" data-aos="fade-down">
                                ...
                                <a className="btn btn-md btn-outline-dark" href="#" rel="noreferrer">Conoce más</a>
                            </div>
                        </div>
                        <div className="col-12 col-lg-3">
                            <div className="izquiTar tarjetaProducto" data-aos="fade-down">
                        ...
                        <div className="col-12 col-lg-3">
                            <div className="dereTar tarjetaProducto " data-aos="fade-down">
                                <img src={Logo} width="50" alt="Imagen Hidro" />
                                <p className="fw-bold h6 pt-3 pb-3">ASEGURADORA HIDRÁULICA</p>
                                <p>Todos los productos que conoces e intalas te hacen ganar más dinero y acumular puntos</p><br/>
                                <a className="btn btn-md btn-outline-dark" href="#" rel="noreferrer">Conoce más</a>
                            </div>
                        </div>
                ...
                <div className="text-center pt-5 mt-2 pb-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                    <a href="#" className="btn btn-md btn-dark fw-bold animarBotonDescargar" rel="noreferrer">
                    ...
                    <div className=" pt-5">
                        <div  className="container centarContenido mt-4">
                            <div className="barraCeleste2 text-black fw-bold text-center">
                                <div className="espacioEntre2">CON HIDROCOMPRAS AHORRAS CON LAS MARCAS FAVORITAS</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row pt-2 mt-4">
                        <div className="col-12 col-sm-6 pt-5 mt-5" data-aos="flip-down">
                            <div className="modificarEspacio pb-5">
                                <p className="h3">Por primera vez no solo ganas por instalar, ganas usando hidrocompras.</p>
                                <p className="h5 pt-4 mb-5">Somos la primera App para Plomeros y Técnicos que quieren ganar más.</p>
                                <a href="#" className="btn btn-md btn-dark " rel="noreferrer">&nbsp;&nbsp;&nbsp;&nbsp;Ver premios&nbsp;&nbsp;&nbsp;&nbsp;</a>
                            </div>
                        </div>
                        ...
                        <div className="row mt-2 pt-3">
                            ...
                            <div className="col-12 col-md-3">
                                <div className="tarjetaTiene" data-aos="flip-up">
                                    ...
                                    <p className="h5 pt-3 text-center">Como ingreso extra <strong>atendiendo</strong> / <strong>refiriendo</strong> tan solo 10 productos</p>
                                </div>
                            </div>
                            <div className="col-12 col-md-3">
                                <div className="tarjetaTiene" data-aos="flip-up">
                        ...
                        <div className="row">
                            <div className="col-12 col-lg-6" data-aos="flip-up">
                                <div className="cajaWQue text-center">
                                    <br />
                                    <p className="h2 fw-bold text-center pt-3 mt-3">ÚNETE A LA COMUNIDAD DE PLOMEROS MÁS GRANDE DE GUATEMALA</p>
                                    <br/>
